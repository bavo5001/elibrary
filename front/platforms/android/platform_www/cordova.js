 ...
 */
var cordova = require('front/platforms/android/platform_www/cordova'),
...
channel.join(function () {
    ...
    // side.
    channel.join(function () {
        require('front/platforms/android/platform_www/cordova').fireDocumentEvent('deviceready');
...
module.exports = {
    ...
    bootstrap: function() {
        var channel = require('cordova/channel'),
            cordova = require('front/platforms/android/platform_www/cordova'),
...
var APP_PLUGIN_NAME = Number(require('front/platforms/android/platform_www/cordova').platformVersion.split('.')[0]) >= 4 ? 'CoreAndroid' : 'App';
...
window.cordova = require('front/platforms/android/platform_www/cordova');
